...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 版权信息
			function showAbout(){
				$.messager.alert("OA系统 v1.0","设计: fengchuan<br/> 管理员邮箱: 804565997@qq.com <br/> QQ: 804565997");
			}
		</script>
	</head>
					...
					<tr>
						<td style="width: 300px;">
							<div style="color: #999; font-size: 8pt;">
								百度外卖 | Powered by <a href="http://www.baidu.com/">baidu.com</a>
							</div>
						</td>
